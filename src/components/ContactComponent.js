...
errors.telnum='tel no should contain no only'
else if(this.state.touched.telnum && telnum.length>=10)
errors.telnum='tel contain 10 no'
if(this.state.touched && email.split('').filter(x => x==='@').length !==1)
errors.email="email should contain errors"
return errors
}
   render() {
    ...
    return(
        <div className="container">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-med-9">
                        ...
                        <FormGroup row>
                            ...
                            <FormGroup check>
                                <Label check>
                                    ...
                                    <strong>May be contanct you?</strong>
                                </Label>
                            </FormGroup>
                            </Col>
